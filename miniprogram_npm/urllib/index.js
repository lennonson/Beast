...
__DEFINE__(1745133307477, function(require, module, exports) {
...
}, function(modId) {var map = {"./urllib":1745133307478,"./httpclient":1745133307482,"./httpclient2":1745133307483}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1745133307478, function(require, module, exports) {
...
}, function(modId) { var map = {"./detect_proxy_agent":1745133307479,"../package.json":1745133307481}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1745133307479, function(require, module, exports) {
...
}, function(modId) { var map = {"./get_proxy_from_uri":1745133307480}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1745133307480, function(require, module, exports) {
...
__DEFINE__(1745133307481, function(require, module, exports) {
module.exports = {
  "name": "urllib",
  "version": "2.44.0",
  "publishConfig": {
...
__DEFINE__(1745133307482, function(require, module, exports) {
...
}, function(modId) { var map = {"./urllib":1745133307478}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1745133307483, function(require, module, exports) {
...
}, function(modId) { var map = {"./httpclient":1745133307482}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1745133307477);
})()
//miniprogram-npm-outsideDeps=["util","path","dns","net","http","https","url","qs","querystring","zlib","default-user-agent","digest-header","humanize-ms","statuses","content-type","ee-first","pump","utility","formstream","any-promise","constants","iconv-lite","proxy-agent","events"]
