const txt = require("../../data/costume_data")
...
Page({
  ...
  onLoad(options) {
    ...
    this.setData({
      ...
      foreword: `transform: translateY(${screenHeight * 0.09}px); filter: opacity(1);`,
  ...
  slideUp: function() {
    this.setData({
      ...
      matter: `transform: translateY(-${this.data.screenHeight * 0.78}px); filter: opacity(1);`,
      isUp: true,
    })
  },
  //下滑动画
  slideDown: function () {
    this.setData({
      foreword: `transform: translateY(${this.data.screenHeight * 0.09}px); filter: opacity(1);`,
